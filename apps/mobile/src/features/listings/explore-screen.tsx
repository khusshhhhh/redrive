...
export function ExploreScreen() {
  const query = useQuery({ queryKey: ["listings", "explore"], queryFn: () => apiRequest<ListingPage>("/listings", { authenticated: false }) });
