...
type Quote = { days: number; dailyRateCents: number; basePriceCents: number; insuranceType: InsuranceType; insuranceFeeCents: number; cleaningFeeCents: number; totalCents: number; currency: "AUD"; cancellationPolicy: { name?: string; description?: string }; expiresAt: string };
