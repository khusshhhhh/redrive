...
const pages: Record<string, PageContent> = {
  ...
  about: {
    ...
    sections: [
      ...
      { heading: "Meet Khush Patel", body: "Khush Patel is Redrive’s co-founder and CEO. He has shaped the product from the first idea through the details people touch every day: search, trust checks, bookings, messages, handovers, payments, support content and the visual experience." },
      { heading: "Meet Hiral Mahida", body: "Hiral Mahida is Redrive’s co-founder and Khush’s wife. She builds the company alongside him, bringing a close eye to the guest and host experience, trust and safety practice, and the everyday operations that keep a marketplace honest and workable." },
      { heading: "Founder-built means close to the details", body: "Redrive is not being designed from a distant boardroom. Khush and Hiral work directly across product decisions, engineering, marketplace operations and the questions guests and hosts are likely to ask. That closeness keeps the company practical, accountable and able to improve quickly." },
      ...
      { heading: "Trust is a product feature", body: "Email checks, an identity check at the booking request, transparent host profiles, suburb-level public maps, booking records, on-platform messages, structured handovers and review tools help both sides make better decisions. No single badge replaces good judgement, so Redrive explains what its checks do—and what they do not do." },
