...
const SavedSearches: React.FC<SavedSearchesProps> = ({
  ...
  return (
    <div className="bg-white rounded-md shadow-card border border-hairline-soft mb-6">
      <div className="p-4 border-b border-hairline-soft">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-ink">Saved Searches</h3>
            {savedSearches.length > 0 && (
              <span className="bg-surface-strong text-muted text-xs px-2 py-1 rounded-full">
      ...
      {/* Save Dialog */}
      {showSaveDialog && (
        <div className="p-4 bg-surface-soft border-b border-hairline-soft">
          <div className="space-y-3">
            ...
            <div className="text-sm text-muted">
              <strong className="text-ink">Current filters:</strong> {getSearchDescription(currentFilters)}
            </div>
        ...
        <div className="p-4">
          <div className="space-y-3">
            {(isExpanded ? sortedSearches : sortedSearches.slice(0, 3)).map((search) => (
              <div
                key={search.id}
                className="flex items-center justify-between p-3 bg-surface-soft rounded-md hover:bg-surface-strong transition-colors"
              >
      ...
      {savedSearches.length === 0 && (
        <div className="p-6 text-center text-muted">
          <Star className="w-12 h-12 text-hairline mx-auto mb-3" />
