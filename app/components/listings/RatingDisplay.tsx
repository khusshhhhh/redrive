...
const RatingDisplay: React.FC<RatingDisplayProps> = ({ rating, reviewCount }) => {
    ...
    return (
        <section
            ...
            className="relative overflow-hidden rounded-lg border border-accent/30 bg-gradient-to-br from-white via-white to-accent-soft/60 px-5 py-6 shadow-[0_16px_40px_rgba(24,54,58,0.08)] sm:px-7"
        >
            ...
            <div className="relative flex flex-col items-center justify-between gap-6 sm:flex-row sm:gap-8">
                <div className="flex flex-col items-center gap-4 sm:flex-row sm:text-left">
                    <div className="relative flex h-24 w-24 shrink-0 flex-col items-center justify-center rounded-full border-4 border-white bg-ink text-white shadow-[0_10px_24px_rgba(24,54,58,0.22)]">
