                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="text-base text-gray-500 font-light">Choose your destination!</div>
                        </div>
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="text-base font-light text-gray-500">When is the best time to go!</div>
                        </div>
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="text-base font-light text-gray-500">Make sure they are free on those dates!</div>
                        </div>
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="text-base font-light text-gray-500">It is okay to set your budget!</div>
                        </div>
                        <div className="pt-4 pb-3 px-4 bg-gray-100 rounded-md">
                            <Slider
                                value={priceRange}
