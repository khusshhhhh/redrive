...
const EmptyState: React.FC<EmptyState> = ({
    ...
    return (
        ...
        >
            ...
            {actionLabel && actionHref && <button type="button" onClick={() => router.push(actionHref)} className="mt-5 inline-flex min-h-11 items-center gap-2 rounded-full bg-accent px-5 text-sm font-semibold text-ink transition hover:bg-accent-active hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2">{actionLabel}</button>}
        </div>
    );
};
