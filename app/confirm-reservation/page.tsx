...
function ConfirmationSkeleton() { return <main className="bg-surface-soft/40 px-4 py-12"><div className="mx-auto max-w-[1180px] space-y-8"><div className="skeleton-wave h-10 w-80 max-w-full rounded" /><div className="grid gap-8 lg:grid-cols-[1fr_400px]"><div className="space-y-8"><div className="skeleton-wave h-64 rounded-lg" /><div className="skeleton-wave h-52 rounded-lg" /></div><div className="skeleton-wave h-96 rounded-lg" /></div></div></main>; }
