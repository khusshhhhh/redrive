            ...
            {!isOwner && (
                <div className="fixed inset-x-0 bottom-0 z-20 border-t border-hairline bg-white/95 px-4 pt-3 shadow-[0_-8px_24px_rgba(22, 22, 22,0.10)] backdrop-blur md:hidden" style={{ paddingBottom: "max(0.75rem, env(safe-area-inset-bottom))" }}>
                    <div className="mx-auto flex max-w-lg items-center justify-between gap-4">
                        ...
                        <button type="button" onClick={scrollToBooking} className="h-12 shrink-0 rounded-full bg-accent px-5 text-sm font-semibold text-ink transition hover:bg-accent-active hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2">Check availability</button>
                    </div>
                </div>
            )}
        </Container>
