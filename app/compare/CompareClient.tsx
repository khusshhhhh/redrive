...
const CompareClient = ({ vehicles, tripDays }: { vehicles: ComparisonVehicle[]; tripDays: number | null }) => {
  ...
  if (displayedVehicles.length < 2) return (
    <div className="mx-auto flex min-h-[62vh] max-w-md flex-col items-center justify-center px-4 py-16 text-center">
      ...
      <Link href="/explore" className="mt-7 inline-flex min-h-11 items-center rounded-full bg-accent px-6 py-3 text-sm font-semibold text-ink transition hover:bg-accent-active hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2">Explore vehicles</Link>
    </div>
  );
