...
const ReservationDetails = () => {
    ...
    if (loading) {
        return <p className="text-center text-gray-500">Loading reservation details...</p>;
    }
            ...
            <div className="bg-white mt-6 flex flex-col gap-6">
                ...
                <div className="p-6 border-[2px] rounded-xl border-gray-200">
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                        ...
                        <p className="text-gray-700"><span className="font-bold">Address: </span>{reservation.user.streetAddress || "N/A"}, {reservation.user.city}, {reservation.user.state}, {reservation.user.postcode}</p>
                    </div>
                    <div className="mt-4">
                ...
                <div className="items-center justify-center flex gap-4">
                    <button
                        ...
                        className="bg-white text-teal-500 px-16 py-3 width-[50%] rounded-md hover:bg-teal-500 hover:text-white border-[2px] border-teal-500 transition"
                    >
                        Go Back
                    </button>
                </div>
